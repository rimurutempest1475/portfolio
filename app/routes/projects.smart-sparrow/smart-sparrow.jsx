...
import backgroundSpr from '~/assets/gieoduyen.jpg';
...
import imageSprLessonBuilderDark from '~/assets/gieoduyen.jpg';
import imageSprLessonBuilderLightLarge from '~/assets/gieoduyen.jpg';
import imageSprLessonBuilderLightPlaceholder from '~/assets/spr-lesson-builder-light-placeholder.jpg';
import imageSprLessonBuilderLight from '~/assets/spr-lesson-builder-light.jpg';
import videoSprMotionLarge from '~/assets/spr-motion-large.mp4';
import videoSprMotionPlaceholder from '~/assets/spr-motion-placeholder.jpg';
import videoSprMotion from '~/assets/spr-motion.mp4';
import imageSprSchema1DarkLarge from '~/assets/thanhtoan.png';
import imageSprSchema1DarkPlaceholder from '~/assets/spr-schema-1-dark-placeholder.png';
import imageSprSchema1Dark from '~/assets/thanhtoan.png';
import imageSprSchema1LightLarge from '~/assets/thanhtoan.png';
import imageSprSchema1LightPlaceholder from '~/assets/spr-schema-1-light-placeholder.png';
import imageSprSchema1Light from '~/assets/thanhtoan.png';
import imageSprSchema2DarkLarge from '~/assets/thanhtoan.png';
import imageSprSchema2DarkPlaceholder from '~/assets/spr-schema-2-dark-placeholder.png';
import imageSprSchema2Dark from '~/assets/thanhtoan.png';
import imageSprSchema2LightLarge from '~/assets/thanhtoan.png';
import imageSprSchema2LightPlaceholder from '~/assets/spr-schema-2-light-placeholder.png';
import imageSprSchema2Light from '~/assets/thanhtoan.png';
import imageSprStoryboarderDarkLarge from '~/assets/rvsp.png';
import imageSprStoryboarderDarkPlaceholder from '~/assets/spr-storyboarder-dark-placeholder.png';
import imageSprStoryboarderDark from '~/assets/rvsp.png';
import imageSprStoryboarderLightLarge from '~/assets/rvsp.png';
import imageSprStoryboarderLightPlaceholder from '~/assets/spr-storyboarder-light-placeholder.png';
import imageSprStoryboarderLight from '~/assets/rvsp.png';
...
const title = 'Gieo Duyên - Nền tảng thiệp cưới online';
const description =
  'Tôi đã thiết kế và phát triển Gieo Duyên - một nền tảng tạo thiệp cưới online hiện đại, cho phép người dùng tùy chỉnh, chỉnh sửa trực tiếp và quản lý danh sách khách mời với đa dạng phương thức thanh toán.';
const roles = [
  'Thiết kế UX/UI',
  'Phát triển Frontend',
  'Tích hợp thanh toán',
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              ...
              alt="Giao diện chính của nền tảng Gieo Duyên với công cụ tạo thiệp cưới trực quan."
            />
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>Vấn đề cần giải quyết</ProjectSectionHeading>
            <ProjectSectionText>
              Trong thời đại số hóa, việc tạo và gửi thiệp cưới truyền thống gặp nhiều khó khăn: 
              chi phí cao, thời gian in ấn lâu, khó quản lý danh sách khách mời và không thể 
              tùy chỉnh nhanh chóng. Gieo Duyên ra đời để giải quyết những vấn đề này bằng cách 
              cung cấp một nền tảng tạo thiệp cưới online hoàn chỉnh với khả năng tùy chỉnh 
              trực tiếp và quản lý hiệu quả.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            <Image
              ...
              alt={`Bộ component thiết kế cho nền tảng Gieo Duyên với theme ${theme}`}
              sizes="100vw"
            />
            <ProjectTextRow>
              <SegmentedControl
            ...
            <ProjectTextRow>
              <ProjectSectionHeading>Hệ thống thiết kế Gieo Duyên</ProjectSectionHeading>
              <ProjectSectionText>
                Để đảm bảo tính nhất quán và dễ sử dụng, tôi đã xây dựng một hệ thống thiết kế 
                toàn diện bao gồm các component có thể tái sử dụng, bảng màu thống nhất và 
                typography system. Điều này giúp người dùng dễ dàng tạo ra những thiệp cưới 
                đẹp mắt mà không cần kiến thức thiết kế chuyên sâu.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectSectionContent>
            <Image
              ...
              alt="Trang chủ của hệ thống thiết kế Gieo Duyên với các nguyên tắc và component guidelines."
              sizes="100vw"
            />
            <ProjectTextRow>
              <ProjectSectionHeading>Tài liệu thiết kế</ProjectSectionHeading>
              <ProjectSectionText>
                Một hệ thống thiết kế chỉ hiệu quả khi có tài liệu hướng dẫn rõ ràng. 
                Tôi đã tạo ra một trang web tài liệu toàn diện bao gồm các nguyên tắc thiết kế, 
                hướng dẫn UX, accessibility và guidelines cho từng component để đảm bảo tính 
                nhất quán trong toàn bộ sản phẩm.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
          ...
          <ProjectSection
            ...
            backgroundElement={
              <Image
                ...
                alt="Giao diện tạo thiệp cưới với các hiệu ứng animation mượt mà."
                sizes="100vw"
              />
            }
          >
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  <ProjectSectionHeading>Thiết kế chuyển động</ProjectSectionHeading>
                  <ProjectSectionText>
                    Animation là một nguyên tắc cốt lõi trong việc tạo ra trải nghiệm 
                    tạo thiệp trực quan và dễ hiểu. Các element chuyển động theo cách 
                    thể hiện nguyên nhân và kết quả của mỗi tương tác để cải thiện 
                    tính mượt mà của toàn bộ trải nghiệm.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
              <Image
                ...
                alt="Demo quá trình tạo và tùy chỉnh thiệp cưới trên nền tảng Gieo Duyên."
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              <ProjectSectionHeading>Quản lý danh sách khách mời</ProjectSectionHeading>
              <ProjectSectionText>
                Một tính năng quan trọng của Gieo Duyên là khả năng quản lý danh sách 
                khách mời một cách hiệu quả. Người dùng có thể import danh sách từ Excel, 
                tùy chỉnh thông tin khách mời, theo dõi trạng thái RSVP và gửi thiệp 
                tự động qua email hoặc SMS.
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              raised
              ...
              alt="Giao diện quản lý danh sách khách mời với drag and drop và tùy chỉnh thông tin."
        ...
        <ProjectSection>
          <ProjectSectionColumns>
            <ProjectSectionContent>
              <ProjectTextRow>
                <ProjectSectionHeading>
                  Hệ thống thanh toán đa dạng và linh hoạt
                </ProjectSectionHeading>
                <ProjectSectionText>
                  Tích hợp đa dạng các phương thức thanh toán từ thẻ tín dụng/ghi nợ 
                  đến các ví điện tử phổ biến tại Việt Nam như Momo, VNPay, ZaloPay. 
                  Hệ thống thanh toán được thiết kế an toàn, nhanh chóng và dễ sử dụng 
            ...
            <div className={styles.sidebarImages}>
              <Image
                ...
                alt="Các tùy chọn cấu hình cho component thanh toán."
              ...
              <Image
                ...
                alt="Các tùy chọn cấu hình cho text và nội dung thiệp."
                sizes={`(max-width: ${media.mobile}px) 50vw, 25vw`}
              />
            </div>
          </ProjectSectionColumns>
          ...
          <Suspense>
                ...
                () => [
                  {
                    ...
                    text: 'Tùy chỉnh thiệp',
                    hidden: true,
                  },
                  {
                    position: [0.47, -0.38, 0.04],
                    text: 'Quản lý khách mời',
                    hidden: true,
                  },
                  {
            ...
            >
                ...
                <ProjectSection>
                  <ProjectSectionContent>
                    <ProjectTextRow center>
                      <ProjectSectionHeading>
                        Trải nghiệm tạo thiệp cưới thế hệ mới
                      </ProjectSectionHeading>
                      <ProjectSectionText>
                        Tính linh hoạt của sản phẩm cho phép tạo ra những trải nghiệm 
                        tương tác hấp dẫn với các plugin có thể cấu hình cao, giúp 
                        người dùng dễ dàng tùy chỉnh và tạo ra những thiệp cưới độc đáo.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                  ...
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      <ProjectSectionHeading level={4} as="h3">
                        Tích hợp 3D vào thiết kế
                      </ProjectSectionHeading>
                      <ProjectSectionText>
                        Một ví dụ thú vị là plugin màn hình 3D. Người dùng có thể 
                        tải bất kỳ model 3D nào vào và cấu hình vị trí camera để 
                        tạo hiệu ứng animation cho từng phần.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="start" width="s">
                      ...
                      <ProjectSectionText>
                        Người dùng có thể được hướng dẫn đến các phần cụ thể của model 
                        và xem các label. Họ cũng có thể click và kéo để xoay quanh 
                        và tự do khám phá bất cứ lúc nào.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
              ...
              <EarthSection
                ...
                labels={['Mobile App', 'Web Platform', 'API Integration']}
              >
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                        Người dùng có thể chọn animation có sẵn trong model để phát 
                        hoặc lặp cho bất kỳ phần nào mà không cần sử dụng các công cụ 
                        animation phức tạp.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                Dự án Gieo Duyên đã thành công với việc tạo ra một nền tảng tạo thiệp cưới 
                online hoàn chỉnh, hiện đại và dễ sử dụng. Nền tảng đã thu hút hàng nghìn 
                người dùng và trở thành một trong những giải pháp hàng đầu trong lĩnh vực 
                thiệp cưới số tại Việt Nam.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
